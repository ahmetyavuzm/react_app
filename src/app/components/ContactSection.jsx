  ...
  return (
    ...
    <div className='flex flex-col items-center justify-start md:items-start md:justify-around md:flex-row w-full h-full '>
        <div className='flex flex-col justify-center md:items-start items-center  w-[220px] sm:w-[300px] lg:w-[500px] text-center md:text-start  '>
            <h1 className='font-semibold text-md lg:text-2xl'>{content["title"]}</h1>
            <p className='text-darktext text-sm lg:text-lg'>{content["description"]}</p>
        ...
        <form className='w-10/12 h-full mt-8 sm:w-[300px] lg:w-[400px] md:mt-0'>
            ...
            <div className='mb-2 lg:mb-8'>
                <h1 className='text-md lg:text-2xl font-semibold text-gray-200'>{content["form"]["subject"]["title"]}</h1>
                <InputBox className='text-sm md:text-lg' type="text" placeholder={content["form"]["subject"]["placeholder"]} />
            </div>
            <div className='mb-2 lg:mb-8'>
